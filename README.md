<p align="center">
  <img src="./ExergiaCodebanner.png" alt="Banner" style="max-width: 100%; height: auto;">
</p>
...
Construcción de APIs (interfaces de programación de aplicaciones), datos y modelos aplicados a problemas de ingeniería química. Interés fuerte en desarrollo Web, DevOps, desarrollo de modelos IA, seguridad.
...
### 🖥️ Enfoque software (Herramientas principales): 
- 🔵 Backend: FastAPI, Django, PostgreSQL, Elasticsearch, SQLite
- 🔵 Frontend: SolidJS, ViteJS, TailwindCSS, Flowbite 
- 🔵 Data Science / ML: Pandas, NumPy, Scipy, Sympy, Scikit-Learn, XGBoost,TensorFlow/PyTorch, Bokeh, Seaborn
- 🔵 DevOps: Linux, Docker, NGINX, AWS Cloud, Git, GitHub Actions (CI/CD: integración continua/entrega continua)

### ⚗️ Enfoque Ingeniería química
...
### Herramientas software que se implementan (o se implementaran) en proyectos del repositorio:
- 🐍 Python
- 🎨 HTML/CSS
...
### Herramientas software de interes (a implementar en un futuro):
